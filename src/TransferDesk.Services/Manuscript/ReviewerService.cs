...
namespace TransferDesk.Services.Manuscript
{
    public class ReviewerService
    {
        ...
        public void GetMailDetailsMsScreening(Dictionary<String, String> dicReplace, int reviewerInfoID, int? msReviewersSuggestionID, string userID)
        {
            _manuscriptScreeningBL.GetMailDetailsMsScreening(dicReplace, reviewerInfoID, msReviewersSuggestionID, userID);
        }
