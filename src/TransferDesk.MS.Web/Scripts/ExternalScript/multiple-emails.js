(function( $ ){
	...
	$.fn.multiple_emails = function(options) {		
		...
		return this.each(function() {
			...
			var $container = $('<div class="multiple_emails-container" id="emailContainer" />').click(function () { $input.focus(); }).focusin(function (e) {
			    $("#emailContainer").css('border', '2px solid #A6C8FF');
			}).focusout(function (e) {
			    $("#emailContainer").css('border', '1px solid #ccc');
			}); // container div
			...
			*/
			function display_email(t, dupEmailCheck) {			   
				...
				for (var i = 0; i < arr.length; i++) {
				    ...
				    if (dupEmailCheck === true && $orig.val().toLowerCase().indexOf(arr[i].toLowerCase()) != -1) {
