$(document).ready(function () {
    ...
    $("#MSID").focusout(function (e) {
  
       // $.get(AppPath + "ManuscriptLogin/CheckForAliasName", { "msid": $("#MSID").val(), journalTitleID: $("#ddlJournalTitle").val() }, function (aliascheck) {
       //     if (aliascheck.toLocaleLowerCase() == "false") {
       //         if ($("#MSID").val() != "" &&  $("#MSID").val() != null) {
       //             alert("Manuscript Number and Journal title code doesnt match.");
       //             $("#MSID").val("");
       //             return false;
       //         }
       //     }
        ...
        $.ajax({
            method: "GET",
            url: AppPath + "ManuscriptLogin/CheckForAliasName",
            contentType: "application/json; charset=utf-8",
            data: { "msid": $("#MSID").val(), journalTitleID: $("#ddlJournalTitle").val() },
            aynch: false,
            success: function (aliascheck) {
                if (aliascheck.toLocaleLowerCase() == "false") {
                    if ($("#MSID").val() != "" && $("#MSID").val() != null) {
                        alert("Manuscript Number and Journal title code doesnt match.");
                        $("#MSID").val("");
