    ...
    public class ManuscriptDBContext : DbContext, DataContexts.IManuscriptDBContext
    {
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
          ...
          .Configure(c => c.HasColumnType("datetime2"));
            ...
            modelBuilder.Entity<Entities.AutoLoginEmailsForMsJournals>();
            ...
            modelBuilder.Entity<TransferDesk.Contracts.Manuscript.ComplexTypes.AdminDashBoard.pr_GetAutoLoginJournalDetails>();
        ...
        public virtual DbSet<Entities.AutoLoginEmailsForMsJournals> AutoLoginEmailsForMsJournals { get; set; }
